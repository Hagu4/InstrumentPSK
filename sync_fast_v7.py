...
files_to_sync = [
    ...
    ('DjangoWebProject1/app/static/app/css/admin_custom_v3.css', '/app/app/static/app/css/admin_custom_v3.css'),
...
try:
    ...
    with SCPClient(ssh.get_transport()) as scp:
        for local_path, container_abs_path in files_to_sync:
            ...
            # Manually ensure staticfiles copy
    ...
    print("\nREINFORCED ADMIN FIX V3 APPLIED! Please test with Ctrl+F5.")
