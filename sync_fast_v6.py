...
files_to_sync = [
    ...
    ('DjangoWebProject1/app/static/app/css/admin_custom_v2.css', '/app/app/static/app/css/admin_custom_v2.css'),
...
try:
    ...
    print("\nREINFORCED ADMIN FIX APPLIED! Please test with Ctrl+F5.")
