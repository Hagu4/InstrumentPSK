...
with SCPClient(ssh.get_transport()) as scp:
    ...
    scp.put(r'D:\Studies\Lab and pars\Web-ProgDJ(2)\DjangoWebProject1\DjangoWebProject1\app\forms.py', '/root/InstrumentPSK/DjangoWebProject1/app/forms.py')
...
ssh.close()
print("Uploaded forms.py and index.html.")
